...
def generate_seteuk_markdown(student, student_name):
    ...
    subject_groups = {
        ...
        '영어': ['영어', '영국 문학 I', '영국 문학 II', '영국 문학Ⅰ', '영국 문학Ⅱ', '영국 문학 I', '영국 문학 II',
                ...
                'AP 영문학 1', 'AP 영문학 2', 'AP 영문학Ⅰ', 'AP 영문학Ⅱ', 'AP 영문학 I', 'AP 영문학 II',
                'AP English Literature 1', 'AP English Literature 2', 'AP English Literature I', 'AP English Literature II'],
        '수학': ['수학', '수학I', '수학II', '수학Ⅰ', '수학Ⅱ', '수학 I', '수학 II',
                'AP 통계학', 'AP Statistics', '수학적 사고와 통계',
                'AP 미적분학 BC-1', 'AP 미적분학 BC-2', 'AP 미적분학 BC-I', 'AP 미적분학 BC-II',
                'AP 미적분학 BC I', 'AP 미적분학 BC II', 'AP Calculus BC-1', 'AP Calculus BC-2',
                'AP Calculus BC I', 'AP Calculus BC II'],
        ...
        '제2외국어': ['스페인어 I', '스페인어 II', '스페인어Ⅰ', '스페인어Ⅱ', '스페인어II',
                    ...
                    '프랑스어 I', '프랑스어 II', '프랑스어Ⅰ', '프랑스어Ⅱ', '프랑스어II', '프랑스어2',
                    '프랑스어 독해와 작문 I', '프랑스어 독해와 작문 II', '프랑스어 독해와 작문Ⅰ', '프랑스어 독해와 작문Ⅱ',
